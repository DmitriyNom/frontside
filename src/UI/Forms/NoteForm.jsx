...
//          toast.error('Название заметки обязательно!', {
//             position: "top-right",
//             autoClose: 3000,
...
//       } catch (error) {
//          toast.error(error.message || 'Произошла ошибка при сохранении заметки', {
//             position: "top-right",
//             autoClose: 5000,
//             hideProgressBar: false,
//             closeOnClick: true,
...
const NoteForm = ({ isOpen, onClose, note = null, isEdit = false }) => {
   ...
   const handleSubmit = async (e) => {
      ...
      if (noteType !== 'personal_note') {
         ...
         let plannedDateTime = form.planned_date;
         if (form.planned_time) {
            plannedDateTime = `${form.planned_date}T${form.planned_time}`;
         }
         ...
         Object.assign(noteData, {
            ...
            status: 'active' // Начальный статус для задания
         });
      }
